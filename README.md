...
With the release of Apple Silcon based workstations, I've needed to work with multiple processor architectures when using contaienrs, primarily amd64 and arm64, but also s390x and ppc64le.  This is technically done use QEMU to emulate other processors, but this is mostly hidden from the user. The following are my notes on how to (mostly) successfully do this.
